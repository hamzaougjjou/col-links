...
<div class="min-h-[calc(100vh-300px)] mt-14 relative">


    <svg width="380px" class="svg404" height="500px" viewBox="0 0 837 1045" version="1.1"
    ...
    <div class="message-box">
        <h1 class="text-red-500 text-9xl">404</h1>
        <p>
            صفحة غير موجودة
        </p>
        <div class="buttons-con">
            <div class="action-link-wrap w-full">
                <a onclick="history.back(-1)" class="inline-block mt-4 bg-[#D53692] text-white py-3
            hover:scale-105 mx-12 min-w-[100px] text-center
            px-4 rounded-full hover:bg-[#D53692]  transition">
                    عودة
                </a>
                <a href="/" class="inline-block mt-4 bg-[#D53692] text-white pb-3
            hover:scale-105 mx-12 min-w-[100px] text-center pt-4
            px-4 rounded-full hover:bg-[#D53692]  transition">
...
<div class="bg-white/30 w-full h-auto py-8 flex items-center justify-center gap-4 flex-wrap">
    ...
    <a href="https://facebook.com/hamzaougjjou"
    ...
    <a href="https://instagram.com/hamzaougjjou"
        class="group transition-all inline-block duration-500 hover:-translate-y-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
    ...
    <a href="https://x.com/HamazaOugjjou" class="group transition-all inline-block duration-500 hover:-translate-y">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
    ...
    <a href="https://wa.me/+2120637820834" class="group transition-all inline-block duration-500 hover:-translate-y-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 93 92" fill="none">
    ...
    <a href="https://www.linkedin.com/in/hamzaougjjou/"
        class="group transition-all inline-block duration-500 hover:-translate-y-2">
    ...
    <a href="mailto:info@col-link.com" class="group transition-all inline-block duration-500 hover:-translate-y-2">
        <svg width="48" height="48" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                fill="#4285F4" />
            <path d="M59.5732 66.1236H68.056C70.0676 66.1236 71.6914 64.4937 71.6914 62.4881V36.4341L59.5732 45.5227"
                fill="#34A853" />
            <path d="M59.5732 29.7693V45.5229L71.6914 36.4343V31.587C71.6914 27.0912 66.5594 24.5282 62.9663 27.2245"
                fill="#FBBC04" />
